...
public class OntoDSLSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OntoDSLPackage.DSL_MEDIATION: {
				...
				if (result == null) result = caseClassifier(dslMediation);
				if (result == null) result = caseRelationship(dslMediation);
				if (result == null) result = caseNamespace(dslMediation);
				if (result == null) result = caseRedefinableElement(dslMediation);
				if (result == null) result = caseType(dslMediation);
				if (result == null) result = casePackageableElement(dslMediation);
				if (result == null) result = caseNamedElement(dslMediation);
				if (result == null) result = caseElement(dslMediation);
				if (result == null) result = caseEModelElement(dslMediation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OntoDSLPackage.DSL_RELATOR: {
				DslRelator dslRelator = (DslRelator)theEObject;
				T result = caseDslRelator(dslRelator);
				if (result == null) result = caseRelator(dslRelator);
				if (result == null) result = caseMomentClass(dslRelator);
				if (result == null) result = caseClass(dslRelator);
				if (result == null) result = caseClassifier(dslRelator);
				if (result == null) result = caseNamespace(dslRelator);
				if (result == null) result = caseRedefinableElement(dslRelator);
				if (result == null) result = caseType(dslRelator);
				if (result == null) result = casePackageableElement(dslRelator);
				if (result == null) result = caseNamedElement(dslRelator);
				if (result == null) result = caseElement(dslRelator);
				if (result == null) result = caseEModelElement(dslRelator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OntoDSLPackage.DSL_MODEL: {
				DslModel dslModel = (DslModel)theEObject;
				T result = caseDslModel(dslModel);
				if (result == null) result = caseModel(dslModel);
				if (result == null) result = casePackage(dslModel);
				if (result == null) result = caseNamespace(dslModel);
				if (result == null) result = casePackageableElement(dslModel);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dsl Mediation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dsl Mediation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDslMediation(DslMediation object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dsl Relator</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dsl Relator</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDslRelator(DslRelator object) {
		return null;
	}
